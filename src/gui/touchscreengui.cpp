...
void TouchScreenGUI::handleReleaseEvent(size_t evt_id)
{
    ...
    {
      bool bTapDetection = g_settings->getBool("legacy_tap_detection");
			doRightClick(bTapDetection);
    }
	}
...
bool TouchScreenGUI::doRightClick(bool bIsLegacy)
{
  if (bIsLegacy)
	{
	...
	u16 max_delta = (bIsLegacy) ? 400 : 100;
