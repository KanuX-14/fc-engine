...
freecraft.register_craftitem("callbacks:callback_item_1", {
	...
	on_drop = function(itemstack, dropper, pos)
		...
		return freecraft.item_drop(itemstack, dropper, pos)
	end,
	...
	on_pickup = function(itemstack, picker, pointed_thing, ...)
		...
		if ctrl.sneak then
			...
			local leftover = freecraft.item_pickup(taken, picker, pointed_thing, ...)
		...
		elseif ctrl.left then
			-- Eat it
			return freecraft.do_item_eat(2, nil, itemstack, picker, pointed_thing)
		else
			-- Normal: pick up everything
			return freecraft.item_pickup(itemstack, picker, pointed_thing, ...)
		end
	end,
...
freecraft.register_craftitem("callbacks:callback_item_2", {
