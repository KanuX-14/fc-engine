...
for k,v in pairs(simple_nodes) do
	freecraft.register_node("soundstuff:"..k, {
		description = v[1].."\n"..v[3],
...
freecraft.register_node("soundstuff:place_failed_attached", {
...
freecraft.register_node("soundstuff:fall", {
...
freecraft.register_node("soundstuff:fall_attached", {
...
freecraft.register_node("soundstuff:footstep_liquid", {
...
freecraft.register_node("soundstuff:footstep_climbable", {
...
freecraft.register_tool("soundstuff:punch_use", {
...
freecraft.register_tool("soundstuff:punch_use_air", {
...
freecraft.register_node("soundstuff:positional", {
	...
	on_timer = function(pos, elapsed)
		...
		freecraft.sound_play("soundstuff_mono", { pos = pos, max_hear_distance = dist })
		local timer = freecraft.get_node_timer(pos)
		timer:start(0.7)
	end,
	on_rightclick = function(pos, node, clicker)
		...
		if clicker and clicker:is_player() then
			...
			freecraft.chat_send_player(clicker:get_player_name(), "max_hear_distance = " .. diststr)
		end
	end,
