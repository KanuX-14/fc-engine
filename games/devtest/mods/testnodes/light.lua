...
for i=1, freecraft.LIGHT_MAX do
	freecraft.register_node("testnodes:light"..string.format("%02d", i), {
...
freecraft.register_node("testnodes:sunlight_filter", {
...
freecraft.register_node("testnodes:sunlight_propagator", {
