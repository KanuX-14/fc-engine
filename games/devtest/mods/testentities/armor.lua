...
freecraft.register_entity("testentities:armorball", {
	initial_properties = {
		hp_max = 20,
		physical = false,
	...
	on_activate = function(self, staticdata)
		freecraft.log("action", "[testentities] armorball.on_activate")
	...
	on_punch = function(self, puncher, time_from_last_punch, tool_capabilities, dir, damage)
		...
		freecraft.chat_send_player(name, "time_from_last_punch="..string.format("%.3f", time_from_last_punch).."; damage="..tostring(damage))
	end,
})
