FreeCraft Texture Pack Reference
===============================
...
the apple texture of FreeCraft, add a PNG file named `default_apple.png`.
...
* `moon.png`: texture of the moon. Default texture is generated by FreeCraft
* `moon_tonemap.png`: tonemap to be used when `moon.png` was found
* `sun.png`: texture of the sun. Default texture is generated by FreeCraft
...
FreeCraft has three modes for rendering leaves nodes if the node has the
