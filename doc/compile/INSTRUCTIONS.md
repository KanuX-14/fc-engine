...
Dependencies
------------
| Package    | URL                                                    | Commentary                                                             |
|------------|--------------------------------------------------------|------------------------------------------------------------------------|
| CMake      | https://gitlab.kitware.com/cmake/cmake                 |                                                                        |
| Freetype   | https://gitlab.freedesktop.org/freetype/freetype       |                                                                        |
| GMP        | https://gmplib.org/                                    | Bundled mini-GMP is used if not present.                               |
| Clang      | https://clang.llvm.org/                                | or GCC.                                                                |
| IrrlichtMt | https://github.com/minetest/irrlicht                   | Custom version of [Irrlicht](https://github.com/minetest/irrlicht).    |
| JPEG       | https://github.com/uclouvain/openjpeg                  |                                                                        |
| JsonCPP    | https://github.com/open-source-parsers/jsoncpp         | Bundled JsonCPP is used if not present.                                |
| LuaJIT     | http://luajit.org/                                     | Bundled Lua 5.1 is used if not present.                                |
...
| Optional   | URL                                                    | Commentary                                                             |
|------------|--------------------------------------------------------|------------------------------------------------------------------------|
| Git        | https://git.kernel.org/pub/scm/git/git.git/            | Keep game up to date.                                                  |
...
- [Android](android/INSTRUCTIONS.md).
- [MacOS](macos/INSTRUCTIONS.md).
