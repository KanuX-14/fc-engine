FreeCraft Lua Mainmenu API Reference 5.8.0
=========================================
...
* `core.download_file(url, target)` (possible in async calls)
    ...
    * returns true/false
* `freecraft.get_http_api()` (possible in async calls)
...
* `core.get_modpaths()` (possible in async calls)
    * returns table of virtual path to global modpaths, where mods have been installed
      ...
      directories by FreeCraft -- they might be read-only.

      Ex:

      ```lua
      {
          mods = "/home/user/.freecraft/mods",
          share = "/usr/share/freecraft/mods",

          -- Custom dirs can be specified by the FREECRAFT_MOD_DIR env variable
...
[lua_api.md](https://gitlab.com/KanuX/freecraft/-/blob/master/doc/lua_api.md)
...
* `freecraft.encode_base64(string)` (possible in async calls)
  * Encodes a string in base64.
* `freecraft.decode_base64(string)` (possible in async calls)
